...
[[ Screenshot of a Discrete Setting with static options ]]
...
[[ Screenshot of a Leaf Category with setting groups ]]
...
[[ Screenshots of Blueprint script adding WBP_HUD and WBP_SettingsScreen ]]
...
[[ Screenshot of Project Settings > Settings Framework ]]

* Now when we start the game, we'll see the settings screen, with all settings populated.

[[ Maybe a screenshot of the settings screen here. ]]
...
## 4 - Setting up Common UI and Enhanced Input for Navigation and Keybind Widget
...
[[ Screenshot with action prompts ]]