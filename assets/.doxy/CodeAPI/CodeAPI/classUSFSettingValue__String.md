...
# Class USFSettingValue\_String



[**ClassList**](annotated.md) **>** [**USFSettingValue\_String**](classUSFSettingValue__String.md)



_Setting value with an underlying string value. Useful for IDs, names, resolutions, etc._ [More...](#detailed-description)
...
```C++
FString USFSettingValue_String::Value;
```
...
```C++
virtual void USFSettingValue_String::DeserializeFromString (
...
```C++
virtual bool USFSettingValue_String::Equals (
...
```C++
virtual FString USFSettingValue_String::SerializeToString () override const
```
